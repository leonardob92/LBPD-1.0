function newmap = bluewhitered_PD(m,x)
...
% INPUT: -m = set 0 to make it working automatically
%        -x = settings for changing colours..
...
%LEONARDO CHANGES..
bottom = x.bottom;
botmiddle = x.botmiddle;
middle = x.middle;
topmiddle = x.topmiddle;
top = x.top;
%UNTIL HERE
